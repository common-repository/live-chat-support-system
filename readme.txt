...
Tags: live chat, Support System, chat sytem, chat, system, support,desktop notification,emoticons,attachments,customer support system
...
Live Chat  plugin is a fully functional free Chat plugin, Add Live Chat plugin to your site to chat by sending emotions and attachments with message notifications, can create agents and send desktop notifications to users and agents.
...
1. Live chat history
2. Offline messages history
3. Live chat settings
4. Live chat theme settings
5. Live chat offline settings
6. Create agents and Agents details
7. Front end view if online  
8. Backend View
9. Front end view if offline.
...
6.can change chat window location to left bottom or right bottom of your site from backend.
